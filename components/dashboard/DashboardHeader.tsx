...
export default function DashboardHeader({ role, user }: DashboardHeaderProps) {
    ...
    // O signOut faz tudo: apaga os cookies, invalida o JWT e limpa o cache do Next.js
        await signOut({ 
            callbackUrl: "/login" // Destino após deslogar (mande para o login ou para a home "/")
        });
    };
    return (
